...
export const metadata: Metadata = {
  ...
  title: {
    default: `${site.name} | AI-Driven Cybersecurity Company in Kerala, India`,
  ...
  openGraph: {
    ...
    locale: site.locale,
    url: site.url,
    title: `${site.name} | AI-Driven Cybersecurity Company in Kerala, India`,
    description: site.description,
    images: [{ url: "/og/default.png", width: 1200, height: 630, alt: site.name }],
  },
  twitter: {
    card: "summary_large_image",
    title: `${site.name} | AI-Driven Cyber Defence`,
    description: site.description,
